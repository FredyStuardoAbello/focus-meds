...
const STEPS = [
  ...
  },
  {
    ...
    desc:  'Permite las notificaciones y mantén la app abierta o en segundo plano durante tu jornada para recibir los recordatorios en el momento exacto.',
    color: '#7c3aed',
  },
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (btn) btn.addEventListener('click', showOnboarding);
});
